defmodule Cellit.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    # Associations for cart and cart items
    has_one :cart, Cellit.Market.Cart
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Cellit.Repo)
  ...
  """
  def valid_password?(%Cellit.Accounts.User{hashed_password: hashed_password}, password)
